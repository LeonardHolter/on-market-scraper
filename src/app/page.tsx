...
export default function Home() {
  ...
  const [minCashFlow, setMinCashFlow] = useState<number>(750_000)
  const [cashFlowInput, setCashFlowInput] = useState('750000')
  const [maxAskingPrice, setMaxAskingPrice] = useState<number>(15_000_000)
  const [maxPriceInput, setMaxPriceInput] = useState('15000000')
